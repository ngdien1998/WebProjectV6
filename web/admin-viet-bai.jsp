        ...
        <form>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-10">
                    ...
                    <select class="form-control border-primary" id="nguoi-viet" name="cmbNguoiViet"
                        ...
                        <option value="ngdien1888@gmail.com">Nguyễn Lê Điền</option>
            ...
            <div class="form-row">
                <div class="form-group col-2">
                    ...
                    <div class="form-check form-check-flat">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="chkThoiGianHienTai"
                                    id="thoi-gian-hien-tai" checked>
                            Thời gian hiện tại
                        </label>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control border-primary" id="loai-bai-viet" name="cmbLoaiBaiViet">
                    ...
                    <option value="1">Tin tức thị trường</option>
